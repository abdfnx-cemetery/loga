...
func (l *Loga) SetOutput(w io.Writer) {
	l.T.SetOutput(w)
	l.D.SetOutput(w)
	l.I.SetOutput(w)
	l.W.SetOutput(w)
...
func (l *Loga) Tracef(format string, v ...interface{}) {
	if l.t {
		l.T.Output(3, fmt.Sprintf(format, v...))
	}
}

func (l *Loga) Debugf(format string, v ...interface{}) {
	if l.d {
		l.D.Output(3, fmt.Sprintf(format, v...))
	}
}

func (l *Loga) Infof(format string, v ...interface{}) {
	if l.i {
		l.I.Output(3, fmt.Sprintf(format, v...))
	}
}

func (l *Loga) Warnf(format string, v ...interface{}) {
	if l.w {
		l.W.Output(3, fmt.Sprintf(format, v...))
	}
}

func (l *Loga) Errorf(format string, v ...interface{}) {
	if l.e {
